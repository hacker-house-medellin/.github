...
3. Review linked pull requests, issues, Linear work, related repositories in `hacker-house-medellin`, and relevant external-organization repositories whenever behavior or contracts cross boundaries.
